# darlene_x/modules/apk_unpack_decompile.py
...
def analyze_apk_unpack(apk_path):
    ...
    # --- Phase 2: Unpack APK ---
    # Find the darlene_x directory (where the code is running from)
    darlene_x_dir = Path(__file__).resolve().parents[2]  # Go up to the Darlene-X root
    output_base_dir = darlene_x_dir / "output"
