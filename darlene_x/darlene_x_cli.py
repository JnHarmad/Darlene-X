...
from darlene_x.modules.banner_display import show_banner
from darlene_x.modules.usb_connection import run_usb_device_operations, upload_apk_via_dialog
from darlene_x.modules.decide_malicious import gather_all_analysis, decide_maliciousness
from darlene_x.modules.report_generator import generate_reports
...
def main():
    ...
    console.print("\n[bold magenta]THANK YOU FOR CHOOSING DARLENE-X![/bold magenta]")
