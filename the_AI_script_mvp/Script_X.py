...
def analyze_apk(apk_path):
    ...
    console.print("\n[bold cyan]Darlene-X - Android Static Analysis Tool[/bold cyan]")
...
def export_to_pdf(data, output_path):
    ...
    # Add Title Page
    title = Paragraph("Darlene-X - Analysis Report", title_style)
    ...
    def add_footer(canvas, doc):
        canvas.saveState()
        footer_text = "Generated by Darlene-X - Android Static Analysis Tool"
